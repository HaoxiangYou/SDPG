...
class G1Hurtle(GenesisEnv):
    ...
    def init_scene(self) -> None:
        ...
        self._action_scale = torch.tensor(
            [
                1.5533, 0.698, 0.157, 1.1694, 0.255, 0.0524,   # left leg
                1.5533, 0.698, 0.157, 1.1694, 0.255, 0.0524,   # right leg
                0.262,                                         # waist
                1.0997, 0.894, 0.314, 0.747, 0.493,          # left arm
                1.0997, 0.894, 0.314, 0.747, 0.493,          # right arm
            ],
            device=self._device,
        )
