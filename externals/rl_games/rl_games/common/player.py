...
class BasePlayer(object):
    ...
    def run(self):
        ...
        if self.balance_env_rewards:
            ...
            per_env_avg_rewards[valid_envs] = per_env_rewards[valid_envs] / per_env_games_played[valid_envs]
            per_env_avg_steps[valid_envs] = per_env_steps[valid_envs] / per_env_games_played[valid_envs]

            overall_avg_reward = per_env_avg_rewards[valid_envs].mean().item()
            overall_avg_steps = per_env_avg_steps[valid_envs].mean().item()

            if print_game_res:
                per_env_avg_game_res[valid_envs] = per_env_game_res[valid_envs] / per_env_games_played[valid_envs]
                ...
                print("av reward:", overall_avg_reward * n_game_life, "av steps:", overall_avg_steps * n_game_life)
        else:
            print(sum_rewards)
            if print_game_res:
                print(
